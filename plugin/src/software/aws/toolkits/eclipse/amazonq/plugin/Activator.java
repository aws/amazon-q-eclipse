...
import software.aws.toolkits.eclipse.amazonq.views.actions.AmazonQAbstractCommonActions;
...
public class Activator extends AbstractUIPlugin {
    ...
    private static AmazonQAbstractCommonActions globalCommonActions = AmazonQGlobalCommonActions.getInstance();
