...
/**
 * Utility class for ABAP/ADT-related constants and helper methods.
...
public final class AbapUtil {
    ...
    private static final Set<String> ABAP_EXTENSIONS = Set.of(
        "asprog", "aclass", "asinc", "aint", "assrvds", 
        "asbdef", "asddls", "astablds", "astabldt", "amdp",
        "apack", "asrv", "aobj", "aexit", "abdef"
    );
     ...
     */
    public static boolean isAdtEditor(String className) {
     ...
     */
    public static String convertSemanticUriToPath(String semanticUri) {
     ...
     */
    public static String getSemanticCachePath(String workspaceRelativePath) {
